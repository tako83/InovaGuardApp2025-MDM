        ...
        ApiUtils.checkDeviceStatus(this, serialNumber, isOnline, new ApiUtils.ApiCallback() {
            ...
            public void onSuccess(String response) {
                try {
                    ...
                    boolean isCurrentlyLocked = sharedPreferences.getBoolean(Constants.PREF_IS_LOCKED, false);

                    if (isLockedByAdmin && !isCurrentlyLocked) {
                    ...
                    } else if (!isLockedByAdmin && isCurrentlyLocked) {
                    ...
                    } else if (!isLockedByAdmin && !isCurrentlyLocked && !"N/A".equals(nextPaymentDate)) {
                        Intent reminderIntent = new Intent(MdmService.this, MainActivity.class);

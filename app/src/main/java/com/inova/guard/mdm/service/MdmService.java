...
// Importaciones para la ubicación
...
public class MdmService extends Service {
    ...
    // Nuevo: Cliente para la ubicación
    ...
    public void onCreate() {
        ...
        // Nuevo: Inicializa el cliente de ubicación
    ...
    private void checkConnectivityAndLockStatus() {
        ...
        // Nuevo: Llama al método para enviar la ubicación
        sendLocationToServer();
    }

    // Nuevo: Método para obtener y enviar la ubicación al servidor
        ...
        try {
            fusedLocationClient.getLastLocation().addOnSuccessListener(location -> {
                if (location != null) {
                    ...
                    ApiUtils.sendLocation(this, serialNumber, latitude, longitude, new ApiUtils.ApiCallback() {
                        @Override
                        public void onSuccess(String response) {
                            Log.d(TAG, "Ubicación enviada exitosamente al servidor.");
                        }
                        @Override
                        public void onFailure(String errorMessage) {
                            Log.e(TAG, "Error al enviar la ubicación: " + errorMessage);
                        }
                    });
                }
            });
            ...
            public void onSuccess(String response) {
                try {
                    ...
                    if (isLockedByAdmin && !sharedPreferences.getBoolean(Constants.PREF_IS_LOCKED, false)) {
                        ...
                        Log.d(TAG, "Condición de bloqueo cumplida. Llamando a devicePolicyManager.lockNow()");
